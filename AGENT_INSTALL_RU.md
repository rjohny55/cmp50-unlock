...
прямая загрузка на 6.8.0-138 воспроизводимо вызывает Booter `0x8d`, а
двухэтапный runtime-переход v1 -> FLR -> v2 запускает GSP, но не удерживает
XVE shadow Gen2 и оставляет физическую линию в Gen1.
