...
[20 ГБ](docs/20GB_RU.md). Для 20 ГБ агент обязан начинать со стадии
`stockflow`, затем `rt`; ReBAR и Gen2 нельзя считать подтверждёнными до
указанных в странице 20 ГБ холодных проверок.
